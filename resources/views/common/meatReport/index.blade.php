    ...
    <div class="container panel panel-primary mx-auto" style="min-height: 500px; overflow-y: auto">
        <nav aria-label="breadcrumb" class="mt-4 pt-4">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">精肉レポート</li>
            </ol>
        </nav>
        <h2 class="text-center mb-4 fw-bold">精肉レポート</h2> 
        <div class="panel-heading d-flex justify-content-between mb-2">
        </div>
        <div class="panel-body">
            <div style="width: 100%; padding-left: -10px;">
                <div class="table-responsive" id="meatReportData">
...
<script src="{{asset('assets/js/common/meatReport.js')}}"></script>
@endsection