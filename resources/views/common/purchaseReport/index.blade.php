    ...
    <div class="container panel panel-primary mx-auto" style="min-height:calc(100vh - 350px)">
        <nav aria-label="breadcrumb" class="mt-4 pt-4">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">仕入レポート</li>
            </ol>
        </nav>
        <h2 class="text-center mb-4 fw-bold">仕入レポート</h2> 
...
<script src="{{asset('assets/js/common/purchaseReport.js')}}"></script>
@endsection