<x-app-layout>
    <div class="max-w-lg shadow-lg mx-auto p-4 sm:p-6 lg:p-8">
        <h2 class="text-center text-3xl font-bold mb-5">牧場情報アップデート</h2>
        <form method="POST" action="{{ route('pastorals.update', $pastoral) }}" class="max-w-2xl">
            @csrf
            @method('patch')
            ...
            <div class="md:flex md:items-center">
                ...
                <div class="m-auto">
                    <div class="mt-4 space-x-2">
                        ...
                        <x-primary-button><a href="{{ route('pastorals.index') }}" class="hover:no-underline text-white">{{ __('キャンセル') }}</a></x-primary-button>
                    </div>
                </div>
            </div>
        </form>
