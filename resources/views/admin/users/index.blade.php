...
<style>
    ...
    <div class="container mt-5 pt-5 mb-4">
        ...
        <div class="m-2 rounded-md d-flex justify-content-end">
            <a href="{{ route('users.create') }}" class="btn btn-primary" style="background-color:#f05656;"><i
                    class="fa fa-plus" aria-hidden="true"></i> ユーザー管理</a>
        </div>
                        ...
                        <table id="dtBasicExample" class="table table-striped table-fixed table-bordered table-sm"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800 break-all">{{ $user->name }}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800 break-all">{{ $user->email }}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800 break-all">roles</span>
                                    </td>
                                    <td class="text-center">
                                        <span
                                            class="ml-2 break-all text-gray-600">detail</span>
                                    </td>
                                    <td class="text-center">
